...
import AvayaChatSocket from './component/tds-previous/AvayaChatSocket.js';
import AvayaChatUserInterface from './component/tds-previous/AvayaChatUserInterface.js';
...
import './index-previous.scss';

// noinspection JSCheckFunctionSignatures
class AvayaChatPrevious {
    constructor(config) {
        ...
        this.avayaChatUserInterface = new AvayaChatUserInterface(
            ...
            async (data) => {
                ...
                if (isChatLite) {
                    ...
                    normalizedlocalStorageDetails.phoneNumber = normalizedlocalStorageDetails.phone;
    ...
    async init(useLocalSession = false) {
        ...
        if (customerDetails && !this.avayaChatConfig.modifiedChatInit) {
        ...
        this.userInterfaceEvents.handleUIEvents(this.avayaChatConfig.analyticsIsOn);
    ...
    async submitLead() {
        ...
        const submitLeadData = {
            formId: typeOfPage,
            formData: { ...this.customerDetails,
                attributes: this.avayaChatConfig.attributes.join()
            },
            locale,
            contextID,
        };
    ...
    setUseLatestTDS() {
        setLocalStorage('useLatestTDS', false);
    }
}

export default AvayaChatPrevious;